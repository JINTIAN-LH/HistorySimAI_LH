...
export const DISPLAY_STATE_METRICS = [
  ...
  { key: "rigidLiaoDongTroops", label: "江防兵力", icon: "⚔️", section: "rigid", source: "rigid", rigidPath: "military.liaoDongTroops", defaultValue: 0, invert: false, format: "wanren", bar: "wanren" },
  { key: "rigidLiaoDongMorale", label: "江防军心", icon: "🪖", section: "rigid", source: "rigid", rigidPath: "military.liaoDongMorale", defaultValue: 0, invert: false, format: "score", bar: "direct" },
  { key: "rigidRebelScale", label: "流民兵乱", icon: "🚨", section: "rigid", source: "rigid", rigidPath: "military.rebelScale", defaultValue: 0, invert: true, format: "score", bar: "direct" },
